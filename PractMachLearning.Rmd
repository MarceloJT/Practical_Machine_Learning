...
```{r dataLoading, message=FALSE, warning=FALSE, echo=TRUE}
...
```{r cleaningVars, message=FALSE, warning=FALSE, echo=TRUE}
...
```{r CorMatrix, message=FALSE, warning=FALSE, echo=TRUE, fig.width=20, fig.height=20}
...
```{r RandomForest, message=FALSE, warning=FALSE, echo=TRUE}
# model fit
set.seed(12345)
...
```{r DecisionTrees, message=FALSE, warning=FALSE, echo=TRUE, fig.width=20, fig.height=20}
# model fit
set.seed(12345)
...
confMatDecTree
```
```{r confMatDecTree, message=FALSE, warning=FALSE, echo=TRUE}
# plot matrix results
...
```{r GBM, message=FALSE, warning=FALSE, echo=TRUE}
# model fit
set.seed(12345)
...
```{r TestData, message=FALSE, warning=FALSE, echo=TRUE}
